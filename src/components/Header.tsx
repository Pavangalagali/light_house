  ...
  return (
    <header className="sticky top-0 z-40 w-full glass-panel border-b border-slate-200 dark:border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center justify-center md:justify-end space-x-2 sm:space-x-3 text-sm">
            ...
            <button
              ...
              className="glass-button-secondary text-xs px-2.5 py-2 rounded-xl flex items-center gap-1.5 font-semibold cursor-pointer"
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-2 rounded-xl transition-all font-semibold ${
                activeTab === 'stores' 
            ...
            <button
              onClick={onOpenQuoteDrawer}
              className="flex items-center gap-2 px-3.5 py-2 rounded-xl glass-button-primary text-white font-semibold text-xs sm:text-sm cursor-pointer shadow-md"
            >
              <ShoppingBag className="w-4 h-4 text-white" />
              <span>Quote List</span>
              <span className="bg-white/25 text-white px-1.5 py-0.5 rounded-md text-xs font-extrabold">
                {quoteCount}
              </span>
            </button>
            ...
            <button
              onClick={onOpenAdmin}
              className={`flex items-center gap-1.5 px-3 py-2 rounded-xl transition-all text-xs sm:text-sm font-semibold ${
                isAdminLoggedIn
                  ? 'bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 border border-emerald-500/40'
                  : 'glass-button-secondary text-slate-700 dark:text-slate-200'
              }`}
            >
              <ShieldCheck className={`w-4 h-4 ${isAdminLoggedIn ? 'text-emerald-600 dark:text-emerald-400' : 'text-slate-400'}`} />
        ...
        {/* Shop Filter Sub-bar */}
        <div className="flex items-center justify-between pt-3 mt-3 border-t border-slate-200 dark:border-slate-800 text-xs sm:text-sm overflow-x-auto no-scrollbar">
          <div className="flex items-center space-x-2">
            <span className="text-slate-500 dark:text-slate-400 font-medium mr-1 hidden sm:inline">Browse Shop:</span>
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg font-bold transition-all flex items-center gap-1.5 whitespace-nowrap ${
                selectedShop === 'all' && activeTab === 'catalog'
                  ...
                  : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200/60 dark:hover:bg-slate-800'
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg font-bold transition-all flex items-center gap-1.5 whitespace-nowrap ${
                selectedShop === 'lighthouse' && activeTab === 'catalog'
                  ? 'bg-amber-600 text-white shadow-sm'
                  : 'text-slate-700 dark:text-slate-300 hover:text-amber-700 dark:hover:text-amber-400 hover:bg-amber-100/60 dark:hover:bg-amber-950/30'
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg font-bold transition-all flex items-center gap-1.5 whitespace-nowrap ${
                selectedShop === 'electrical_shop' && activeTab === 'catalog'
                  ...
                  : 'text-slate-700 dark:text-slate-300 hover:text-blue-700 dark:hover:text-blue-400 hover:bg-blue-100/60 dark:hover:bg-blue-950/30'
              }`}
            >
          ...
          <div className="flex items-center gap-3 text-xs text-slate-500 dark:text-slate-400 hidden lg:flex">
            <span className="text-slate-400 dark:text-slate-500">Maps:</span>
            <a
              href="https://maps.app.goo.gl/oX5BepWoruLiGGxa6"
              target="_blank"
              rel="noopener noreferrer"
              className="text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300 flex items-center gap-1 hover:underline font-semibold"
            >
              <MapPin className="w-3 h-3 text-amber-600 dark:text-amber-400" /> Light House
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 flex items-center gap-1 hover:underline font-semibold"
            >
              <MapPin className="w-3 h-3 text-blue-600 dark:text-blue-400" /> Electrical Shop
            </a>
          </div>
        </div>
